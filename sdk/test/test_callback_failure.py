...
class TestCallbackFailure(unittest.TestCase):
    """CallbackFailure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackFailure:
        """Test CallbackFailure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackFailure`
        """
        model = CallbackFailure()
        if include_optional:
