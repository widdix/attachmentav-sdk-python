...
------------- | ------------- | -------------
[**callback_failures_get**](AttachmentAVApi.md#callback_failures_get) | **GET** /callback/failures | 
[**scan_async_download_post**](AttachmentAVApi.md#scan_async_download_post) | **POST** /scan/async/download | 
[**scan_async_result_get**](AttachmentAVApi.md#scan_async_result_get) | **GET** /scan/async/result | 
...
> CallbackFailures callback_failures_get(callback_url, cursor=cursor)
...
with attachmentav.ApiClient(configuration) as api_client:
    ...
    callback_url = 'callback_url_example' # str | URL to receive the scan result via HTTPS POST
    cursor = 'cursor_example' # str | Use the next_cursor value from a previous response to page through failures (optional)

    try:
        api_response = api_instance.callback_failures_get(callback_url, cursor=cursor)
        print("The response of AttachmentAVApi->callback_failures_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AttachmentAVApi->callback_failures_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **callback_url** | **str**| URL to receive the scan result via HTTPS POST | 
 **cursor** | **str**| Use the next_cursor value from a previous response to page through failures | [optional] 
...
> ScanResult scan_async_result_get(trace_id)
...
with attachmentav.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = attachmentav.AttachmentAVApi(api_client)
    trace_id = 'trace_id_example' # str | ID used when submitting the scan job.

    try:
        api_response = api_instance.scan_async_result_get(trace_id)
        print("The response of AttachmentAVApi->scan_async_result_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AttachmentAVApi->scan_async_result_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **trace_id** | **str**| ID used when submitting the scan job. | 
